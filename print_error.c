...
int print_error(t_error type_error)
{
	...
	else if (type_error == TYPE_ERR_MALLOC_PHILO)    printf(MSG_ERR_MALLOC_PHILO);
	...
	else if (type_error == TYPE_ERR_TIME_NEGATIVE)	printf(MSG_ERR_TIME_NEGATIVE);
	else if (type_error == TYPE_ERR_MAX_EAT)	printf(MSG_ERR_MAX_EAT);
	// ----------------------------------
	else if (type_error == TYPE_ERR_MTX_INIT)	printf(MSG_ERR_MTX_INIT);
	// ----------------------------------
	else if (type_error == TYPE_ERR_THD_CREATE)	printf(MSG_ERR_THD_CREATE);
	// ----------------------------------
