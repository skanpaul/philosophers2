...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/01 08:55:40 by ski               #+#    #+#             */
/*   Updated: 2022/04/01 08:55:48 by ski              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include "main.h"
...
{
	d->philo_list = malloc(d->max_philo * sizeof(t_philo));
	if (d->philo_list == NULL)
		return (print_error(TYPE_ERR_MALLOC_PHILO));
	d->mtx_fork_list = malloc(d->max_philo * sizeof(pthread_mutex_t));
